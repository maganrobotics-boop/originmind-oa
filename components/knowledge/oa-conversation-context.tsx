...
function ConversationMenu() {
  ...
  const resetMemberLoading = () => { setMembers([]); setMemberError(''); setLoadingMembers(true); };
  const changeOpen = (nextOpen: boolean) => { if (nextOpen) resetMemberLoading(); setOpen(nextOpen); };
  useEffect(() => {
    if (!open) return;

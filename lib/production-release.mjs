...
export const PRODUCTION_MIGRATION_NAME = "0029_knowledge_visibility_reclassification.sql";
export const PRODUCTION_MIGRATION_SHA256 = "073905ec576c407cb91b09f633201f7846facd5b1bf5256ed9737ef4459313be";
...
export function productionKnowledgeDefinitions(migrationSqlByName, names = Object.keys(REVIEWED_KNOWLEDGE_MIGRATIONS)) {
  ...
  const expectedCount = names.includes("0028_needy_microchip.sql")
    ? 42
...
export function validateProductionMigrationState({
  ...
  if (phase === "before" && sameStrings(appliedNames, expectedNames.slice(0, -4))) {
    ...
    return "pending-0026-0027-0028-0029";
  }
  ...
  if (!sameStrings(appliedNames, expectedNames)) {
    throw new Error(`Production migration ledger must end exactly at ${phase === "before" ? "0025, 0026, 0027, 0028, or 0029" : "0029"}`);
  }
  assertDefinitions(expectedKnowledgeDefinitions, expectedObjects, "migration 0029");
  return "applied";
}

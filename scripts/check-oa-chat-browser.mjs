...
try {
  for (const [name,width,height] of [['desktop',1280,900],['tablet-wide',900,1000],['tablet',820,960],['mobile',390,844],['mobile-landscape',844,390]]) {
    ...
    try {
      ...
      results.push({name,passed:true,viewport:{width,height},before,after,mathFormulas:4,table:true,independentGroups:true,statePreserved:true,stopAndRetry:true,errors});

...
const OPERATIONAL_QUESTION_PATTERN = /(?:合同|报价|预算|订单|交付|进度|排期|会议|纪要|审批|制度|流程|权限|账号|资料|文档|文件|数据|实验|测试|样机|设备|底盘|代码|仓库|BOM|图纸|故障|复位|参数|配置|部署|服务器|密钥|密码)/iu;
const GENERAL_LEARNING_PATTERN = /(?:小白|新手|初学|入门|如何学习|怎么学习|学习路线|学习路径|从零开始|什么是(?:机器人|机械臂)|(?:机器人|机械臂)是什么|(?:机器人|机械臂).{0,8}(?:基础知识|教程|科普))/iu;
